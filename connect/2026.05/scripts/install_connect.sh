...
echo "$d Installing Posit Connect 2026.05.1 $d"

RSTUDIO_INSTALL_NO_LICENSE_INITIALIZATION=1 apt-get install -yf rstudio-connect=2026.05.1-1
...
[Python]
Enabled = true
Executable = /opt/python/3.14.5/bin/python
